...
```bash
git clone https://github.com/IshitaMohanty1906/AGMA-Greenhouse-Agent.git
...
│
├── output/                        # Project screenshots and results
│   ├── agent_running.png
│   ├── comparison_existing_methods.png
│   ├── dashboard_overview.png
│   ├── dataset_analysis-seasonal_temaparature_and_humidity_trends.png
...
![AGMA Dashboard](output/dashboard_overview.png)

### Agent Running Live

![Agent Running](output/agent_running.png)

### Evaluation Metrics

![Metrics](output/metrics.png)

### Evaluation Results

![Evaluation Report](output/evaluation_report.png)

### Existing Methods Comparison

![Comparison with Existing Methods](output/comparison_existing_methods.png)

### Dataset Analysis

![Dataset Analysis](output/dataset_analysis-seasonal_temaparature_and_humidity_trends.png)
